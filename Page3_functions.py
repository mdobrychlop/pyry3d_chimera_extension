...
class Parameters_Window:
    def get_parameters(self):
        pass
    def display(self):
        #self.page2=Tkinter.Tk()

        self.params_window=Tkinter.Tk()
        self.params_window.title("Simulation / scoring parameters")
        
        self.pwframe=Tkinter.Frame(self.params_window,bd=1,relief="ridge",pady=3,padx=3)
        ...
        self.pyrymode1_radio=Tkinter.Radiobutton(self.frame00, text="Evaluation / ranking", variable=self.pyrymode_var, value=1, command=lambda: self.choose_pyrymode(1))
        self.pyrymode1_radio.grid(row=0,column=0,sticky="e")
        
        self.pyrymode2_radio=Tkinter.Radiobutton(self.frame00, text="Simulation", variable=self.pyrymode_var, value=2, command=lambda: self.choose_pyrymode(2))
        self.pyrymode2_radio.grid(row=0,column=1,sticky="e")
        
        ### Basic simulation parameters
        
        self.frame1=Tkinter.LabelFrame(pw,text="Basic simulation parameters")
        self.frame1.grid(row=1,column=0,sticky="nsew")
        
        self.bzz0=Tkinter.Frame(self.frame1)
        self.bzz0.pack(side="right")
        bzz0=Tkinter.Label(self.bzz0,text="")
        bzz0.pack() ### i give up, it's the only way to align this stuff correctly
        
        self.frame0=Tkinter.Frame(self.frame1)
        self.frame0.pack(side="right")
        
        self.simmet_menu=Pmw.OptionMenu(self.frame0,labelpos="w",label_text="SIMMETHOD",initialitem="SimulatedAnnealing",items=["SimulatedAnnealing","Genetic","ReplicaExchange"],menubutton_width=17,command=self.choose_simmethod)
        self.simmet_menu.grid(row=0,column=0,sticky="e",padx=2)
        
        self.steps_entry=Pmw.EntryField(self.frame0,labelpos="w",label_text="STEPS",entry_bg="white",value="1000",entry_width=10,validate={"validator":"real","min":1})
        self.steps_entry.grid(row=2,column=0,sticky="e",padx=2)
        
        self.maxrot_entry=Pmw.EntryField(self.frame0,labelpos="w",label_text="MAXROT",entry_bg="white",value="5",entry_width=10,validate={"validator":"real","min":1,"max":360})
        ...
        self.maxtrx_entry=Pmw.EntryField(self.maxtrans_frame,labelpos="w",label_text="MAXTRANS    x",entry_bg="white",value="5",entry_width=3,validate={"validator":"real"})
        self.maxtrx_entry.pack(side="left")
        self.maxtry_entry=Pmw.EntryField(self.maxtrans_frame,labelpos="w",label_text="y",entry_bg="white",value="5",entry_width=3,validate={"validator":"real"})
        self.maxtry_entry.pack(side="left")
        self.maxtrz_entry=Pmw.EntryField(self.maxtrans_frame,labelpos="w",label_text="z",entry_bg="white",value="5",entry_width=3,validate={"validator":"real"})
        ...
        self.reheat_entry=Pmw.EntryField(self.reheat_frame,labelpos="w",label_text="REHEAT",entry_bg="white",value="1",entry_width=5, validate={"validator":"real"})
        self.reheat_entry.pack(side="left")
        self.reheat_menu=Pmw.OptionMenu(self.reheat_frame,initialitem="False",items=["True","False"], menubutton_width=5)
        ...
        self.rotation_freq_entry=Pmw.EntryField(self.frame3,labelpos="w",label_text="ROTATION_FREQ",entry_bg="white",value="0.3",entry_width=4,validate={"validator":"real"})
        self.rotation_freq_entry.grid(row=0,column=0,sticky="e",padx=2)
        
        self.rotation_cov_freq_entry=Pmw.EntryField(self.frame3,labelpos="w",label_text="ROTATION_COV_FREQ",entry_bg="white",value="0.0",entry_width=4,validate={"validator":"real"})
        self.rotation_cov_freq_entry.grid(row=1,column=0,sticky="e",padx=2)
        
        self.translation_freq_entry=Pmw.EntryField(self.frame3,labelpos="w",label_text="TRANSLATION_FREQ",entry_bg="white",value="0.3",entry_width=4,validate={"validator":"real"})
        self.translation_freq_entry.grid(row=2,column=0,sticky="e",padx=2)
        
        self.exchange_freq_entry=Pmw.EntryField(self.frame3,labelpos="w",label_text="EXCHANGE_FREQ",entry_bg="white",value="0.0",entry_width=4,validate={"validator":"real"})
        self.exchange_freq_entry.grid(row=3,column=0,sticky="e",padx=2)
        
        self.simul_dd_freq_entry=Pmw.EntryField(self.frame3,labelpos="w",label_text="SIMUL_DD_FREQ",entry_bg="white",value="0.0",entry_width=4,validate={"validator":"real"})
        self.simul_dd_freq_entry.grid(row=4,column=0,sticky="e",padx=2)
        
        self.translation_all_freq_entry=Pmw.EntryField(self.frame3,labelpos="w",label_text="TRANSLATION_ALL_FREQ",entry_bg="white",value="0.2",entry_width=4,validate={"validator":"real"})
        self.translation_all_freq_entry.grid(row=5,column=0,sticky="e",padx=2)
        
        self.rotation_all_freq_entry=Pmw.EntryField(self.frame3,labelpos="w",label_text="ROTATION_ALL_FREQ",entry_bg="white",value="0.2",entry_width=4,validate={"validator":"real"})
        self.rotation_all_freq_entry.grid(row=6,column=0,sticky="e",padx=2)
        
        self.exchangesample_freq_entry=Pmw.EntryField(self.frame3,labelpos="w",label_text="EXCHANGESAMPLE_FREQ",entry_bg="white",value="0.0",entry_width=4,validate={"validator":"real"})
        self.exchangesample_freq_entry.grid(row=7,column=0,sticky="e",padx=2)
        
        self.warning_frame=Tkinter.LabelFrame(self.frame3,text="Important")
        self.warning_frame.grid(row=8,column=0,sticky="nsew")
        
        warning_label=Tkinter.Label(self.warning_frame,text="Sum of FREQ parameters must be equal to 1! Click [Help] for more info.",wraplength=150,fg="blue").pack()
        
        ### Method dependent parameters

        self.frame2=Tkinter.LabelFrame(pw,text="Method dependent parameters")
        self.frame2.grid(row=3,column=1,columnspan=2,sticky="nsew")
        
        self.bzzx=Tkinter.Frame(self.frame2)
        self.bzzx.pack(side="right")
        bzzx=Tkinter.Label(self.bzzx,text="")
        bzzx.pack()
        
        self.frame2_5=Tkinter.Frame(self.frame2)
        self.frame2_5.pack(side="right")

        self.ann_temp_entry=Pmw.EntryField(self.frame2_5,labelpos="w",label_text="ANN_TEMP",entry_bg="white",value="10",entry_width=10,validate={"validator":"real","min":1,"max":100})
        self.ann_temp_entry.grid(row=0,column=0,sticky="e",padx=2)
        
        self.replicaexchange_freq_entry=Pmw.EntryField(self.frame2_5,labelpos="w",label_text="REPLICA EXCHANGE_FREQ",label_wraplength=108,entry_bg="white",value="1",entry_width=10,validate={"validator":"real","min":1,"max":self.steps_entry.getvalue()})
        self.replicaexchange_freq_entry.grid(row=1,column=0,sticky="e",padx=2)
        
        self.replicatemperatures_entry=Pmw.EntryField(self.frame2_5,labelpos="w",label_text="REPLICA TEMPERATURES",label_wraplength=108,entry_bg="white",entry_width=10)
        self.replicatemperatures_entry.grid(row=2,column=0,sticky="e",padx=2)
        
        self.reductmet_menu=Pmw.OptionMenu(self.frame2_5,labelpos="w",label_text="REDUCTMETHOD",initialitem="roulette",items=["roulette","cutoff","tournament"],menubutton_width=10)
        ...
        self.outbox_entry1=Pmw.EntryField(self.frame4,labelpos="w",label_text="OUTBOX",entry_bg="white",value="1",entry_width=3,validate={"validator":"real"})
        self.outbox_entry1.grid(row=0,column=0,sticky="e")
        self.outbox_entry2=Pmw.EntryField(self.frame4,labelpos="w",label_text="-",entry_bg="white",value="1",entry_width=3,validate={"validator":"real"})
        self.outbox_entry2.grid(row=0,column=1,sticky="e")
        
        self.map_freespace_entry1=Pmw.EntryField(self.frame4,labelpos="w",label_text="MAP_FREESPACE",entry_bg="white",value="1",entry_width=3,validate={"validator":"real"})
        self.map_freespace_entry1.grid(row=1,column=0,sticky="e")
        self.map_freespace_entry2=Pmw.EntryField(self.frame4,labelpos="w",label_text="-",entry_bg="white",value="1",entry_width=3,validate={"validator":"real"})
        ...
        self.clashes_menu=Pmw.OptionMenu(self.frame4,labelpos="w",label_text="CLASHES",initialitem="CLASHES_ALLATOMS",items=["CLASHES_ALLATOMS","CLASHES"],menubutton_width=8)
        self.clashes_menu.grid(row=2,column=0,sticky="e",padx=2)
        self.clashes_entry1=Pmw.EntryField(self.frame4,labelpos="w",label_text="",entry_bg="white",value="1",entry_width=3,validate={"validator":"real"})
        self.clashes_entry1.grid(row=2,column=1,sticky="e")
        self.clashes_entry2=Pmw.EntryField(self.frame4,labelpos="w",label_text="-",entry_bg="white",value="1",entry_width=3,validate={"validator":"real"})
        self.clashes_entry2.grid(row=2,column=2,sticky="e")
        
        self.restraints_entry1=Pmw.EntryField(self.frame4,labelpos="w",label_text="RESTRAINTS",entry_bg="white",value="1",entry_width=3,validate={"validator":"real"})
        self.restraints_entry1.grid(row=4,column=0,sticky="e")
        self.restraints_entry2=Pmw.EntryField(self.frame4,labelpos="w",label_text="-",entry_bg="white",value="1",entry_width=3,validate={"validator":"real"})
        self.restraints_entry2.grid(row=4,column=1,sticky="e")
        
        self.density_entry1=Pmw.EntryField(self.frame4,labelpos="w",label_text="DENSITY",entry_bg="white",value="1",entry_width=3,validate={"validator":"real"})
        self.density_entry1.grid(row=5,column=0,sticky="e")
        self.density_entry2=Pmw.EntryField(self.frame4,labelpos="w",label_text="-",entry_bg="white",value="1",entry_width=3,validate={"validator":"real"})
        self.density_entry2.grid(row=5,column=1,sticky="e")
        
        self.symmetry_entry1=Pmw.EntryField(self.frame4,labelpos="w",label_text="SYMMETRY",entry_bg="white",value="1",entry_width=3,validate={"validator":"real"})
        self.symmetry_entry1.grid(row=6,column=0,sticky="e")
        self.symmetry_entry2=Pmw.EntryField(self.frame4,labelpos="w",label_text="-",entry_bg="white",value="1",entry_width=3,validate={"validator":"real"})
        ...
        self.threshold_radio=Tkinter.Radiobutton(self.frame7, variable=self.threshold_kvol_var, value=1, command=lambda: self.choose_threshold_kvol(1))
        self.threshold_radio.grid(row=0,column=2,sticky="e")
        
        self.kvol_radio=Tkinter.Radiobutton(self.frame7, variable=self.threshold_kvol_var, value=2, command=lambda: self.choose_threshold_kvol(2))
        self.kvol_radio.grid(row=1,column=2,sticky="e")
        
        self.threshold_entry=Pmw.EntryField(self.frame7,labelpos="w",label_text="THRESHOLD",entry_bg="white",value="20",entry_width=10,validate={"validator":"real"})
        self.threshold_entry.grid(row=0,column=1,sticky="e")
        self.kvol_entry=Pmw.EntryField(self.frame7,labelpos="w",label_text="KVOL",entry_bg="white",value="0.3",entry_width=10,validate={"validator":"real"})
        self.kvol_entry.grid(row=1,column=1,sticky="e")
        self.simbox_entry=Pmw.EntryField(self.frame7,labelpos="w",label_text="SIMBOX",entry_bg="white",value="1.5",entry_width=10,validate={"validator":"real"})
        self.simbox_entry.grid(row=2,column=1,sticky="e")
        self.gridradius_entry=Pmw.EntryField(self.frame7,labelpos="w",label_text="GRIDRADIUS",entry_bg="white",value="1.2",entry_width=10,validate={"validator":"real"})
        self.gridradius_entry.grid(row=3,column=1,sticky="e")
        self.saxsradius_entry=Pmw.EntryField(self.frame7,labelpos="w",label_text="SAXSRADIUS",entry_bg="white",value="2.0",entry_width=10,validate={"validator":"real"})
        self.saxsradius_entry.grid(row=4,column=1,sticky="e")
        self.component_representation_menu=Pmw.OptionMenu(self.frame7,labelpos="w",label_wraplength=100,label_text="COMPONENT_REPRESENTATION",initialitem="fa",items=["ca","cacb","3p","fa"],menubutton_width=5)
        ...
        self.write_n_iter_entry=Pmw.EntryField(self.frame9,labelpos="w",label_text="WRITE_N_ITER",entry_bg="white",value="1",entry_width=10,validate={"validator":"real"})
        self.write_n_iter_entry.grid(row=0,column=0,sticky="e")

        self.out_steps_entry=Pmw.EntryField(self.frame9,labelpos="w",label_text="OUT_STEPS",entry_bg="white",value="1 2",entry_width=10)
        self.out_steps_entry.grid(row=1,column=0,sticky="e")
        
        self.struct_nr_entry=Pmw.EntryField(self.frame9,labelpos="w",label_text="STRUCT_NR",entry_bg="white",value="1",entry_width=10)
        self.struct_nr_entry.grid(row=2,column=0,sticky="e")
        
        self.write_eachbetter_menu=Pmw.OptionMenu(self.frame9,labelpos="w",label_wraplength=70,label_text="WRITE_EACHBETTER",initialitem="False",items=["False","True"],menubutton_width=5)
        self.write_eachbetter_menu.grid(row=3,column=0,sticky="e")
        
        self.write_n_iter_out_steps_var=Tkinter.IntVar()
        
        self.write_n_iter_radio=Tkinter.Radiobutton(self.frame9,variable=self.write_n_iter_out_steps_var, value=1, command=lambda: self.choose_write_n_iter_out_steps(1))
        self.write_n_iter_radio.grid(row=0,column=1,sticky="e")
        
        self.out_steps_radio=Tkinter.Radiobutton(self.frame9,variable=self.write_n_iter_out_steps_var,value=2,command=lambda: self.choose_write_n_iter_out_steps(2))
        ...
        self.scaling_ranges_button=Tkinter.Button(self.frame11,text="SCALE_PARAMS...",command=self.psrwin.deiconify)
        self.scaling_ranges_button.grid(row=0,column=0,sticky="ew",padx=12,pady=3)
        
        self.move_state_button=Tkinter.Button(self.frame11,text="MOVE_STATE...",command=self.mvstwin.deiconify)
        self.move_state_button.grid(row=0,column=1,sticky="ew",padx=12,pady=3)
        self.covalent_bonds_button=Tkinter.Button(self.frame11,text="COVALENT_BONDS...",command=self.covbonwin.deiconify)
        self.covalent_bonds_button.grid(row=0,column=2,sticky="ew",padx=12,pady=3)
        
        ### Help, default, apply, close buttons
        
        self.hdac_frame=Tkinter.Frame(pw,bd=1,relief="ridge",pady=3,padx=3)
        self.hdac_frame.grid(row=6,column=0,columnspan=2,sticky="nsew")
        
        closeparams_button=Tkinter.Button(self.hdac_frame,text="Close",width=10,command=self.params_window.withdraw)
        closeparams_button.pack(side='right')
        paramshelp_button=Tkinter.Button(self.hdac_frame,text="Help",width=10,command=lambda: webbrowser.open("http://genesilico.pl/pyry3d/index.php?option=com_content&view=article&id=52&Itemid=199#3.2"))
        paramshelp_button.pack(side='left')
        paramsdef_button=Tkinter.Button(self.hdac_frame,text="Set defaults",width=10,command=self.set_defaults)
        paramsdef_button.pack(side="left")
        applyparams_button=Tkinter.Button(self.hdac_frame,text="Apply",width=10,command=lambda: self.get_parameters)
    ...
    def display_scaling_ranges_window(self):
        ...
        psr_label=Tkinter.Label(self.psrwf,text="Use the field below to enter your parameters. \nClick [Help] for instructions.",fg="blue").pack(fill="x")
        ...
        self.psrf2=Tkinter.Frame(self.psrwin,bd=1,relief="ridge",pady=3,padx=3)
        self.psrf2.pack(fill="x")
        
        closepsr_button=Tkinter.Button(self.psrf2,text="Close",width=10,command=self.psrwin.withdraw)
        closepsr_button.pack(side='right')
        psrhelp_button=Tkinter.Button(self.psrf2,text="Help",width=10,command=lambda: webbrowser.open("http://genesilico.pl/pyry3d/index.php?option=com_content&view=article&id=52&Itemid=199#3.2"))
        psrhelp_button.pack(side='left')
        psrdef_button=Tkinter.Button(self.psrf2,text="Show example",width=10,command=self.show_scalrang_window_example)#,command=self.set_default_parameters)
        psrdef_button.pack(side="left")
        applypsr_button=Tkinter.Button(self.psrf2,text="Apply",width=10,command=self.get_parameters)
        applypsr_button.pack(side='right')
        
        self.psrwin.withdraw()
        
    def show_movestate_window_example(self):
	self.mvstli.setvalue("D movable 5 5 5 0.1 0.1 0.1 10 10 10 0.1 0.1 1 5 30")
    ...
    def display_move_state_window(self):
        ...
        mvst_label=Tkinter.Label(self.mvstwf,text="Use the field below to enter your parameters. \nClick [Help] for instructions.",fg="blue").pack(fill="x")
        ...
        self.mvstf2=Tkinter.Frame(self.mvstwin,bd=1,relief="ridge",pady=3,padx=3)
        self.mvstf2.pack(fill="x")
        
        closemvst_button=Tkinter.Button(self.mvstf2,text="Close",width=10,command=self.mvstwin.withdraw)
        closemvst_button.pack(side='right')
        mvsthelp_button=Tkinter.Button(self.mvstf2,text="Help",width=10,command=lambda: webbrowser.open("http://genesilico.pl/pyry3d/faq/#3.2"))
        mvsthelp_button.pack(side='left')
        mvstdef_button=Tkinter.Button(self.mvstf2,text="Show example",width=10,command=self.show_movestate_window_example)#,command=self.set_default_parameters)
        mvstdef_button.pack(side="left")
        applymvst_button=Tkinter.Button(self.mvstf2,text="Apply",width=10,command=self.get_parameters)
    ...
    def display_covalent_bonds_window(self):
        ...
        self.covbonwf=Tkinter.LabelFrame(self.covbonwin,text="Covalent bonds")
        self.covbonwf.pack(fill="x")
        covbon_label=Tkinter.Label(self.covbonwf,text="Use the field below to enter your parameters. \nClick [Help] for instructions.",fg="blue").pack(fill="x")
        ...
        self.covbonf2=Tkinter.Frame(self.covbonwin,bd=1,relief="ridge",pady=3,padx=3)
        self.covbonf2.pack(fill="x")
        
        closecovbon_button=Tkinter.Button(self.covbonf2,text="Close",width=10,command=self.covbonwin.withdraw)
        closecovbon_button.pack(side='right')
        covbonhelp_button=Tkinter.Button(self.covbonf2,text="Help",width=10,command=lambda: webbrowser.open("http://genesilico.pl/pyry3d/faq/#3.2"))
        covbonhelp_button.pack(side='left')
        covbondef_button=Tkinter.Button(self.covbonf2,text="Show example",width=10,command=self.show_covbond_window_example)#,command=self.set_default_parameters)
        covbondef_button.pack(side="left")
        applycovbon_button=Tkinter.Button(self.covbonf2,text="Apply",width=10,command=self.get_parameters)
    ...
    def get_parameters(self):
        ...
        self.maxtrans="MAXTRANS "+self.maxtrx_entry.getvalue()+" "+self.maxtry_entry.getvalue()+" "+self.maxtrz_entry.getvalue()
        self.reheat="REHEAT "+self.reheat_menu.getvalue()+" "+self.reheat_entry.getvalue()
        
        self.outbox="OUTBOX "+self.outbox_entry1.getvalue()+" "+self.outbox_entry2.getvalue()
        self.map_freespace="MAP_FREESPACE "+self.map_freespace_entry1.getvalue()+" "+self.map_freespace_entry2.getvalue()
        if self.clashes_menu.getvalue() == "CLASHES":
	    self.clashes="CLASHES "+self.clashes_entry1.getvalue()+" "+self.clashes_entry2.getvalue()
	else:
	    self.clashes="CLASHES_ALLATOMS "+self.clashes_entry1.getvalue()+" "+self.clashes_entry2.getvalue()
        self.restraints="RESTRAINTS "+self.restraints_entry1.getvalue()+" "+self.restraints_entry2.getvalue()
        self.density="DENSITY "+self.density_entry1.getvalue()+" "+self.density_entry2.getvalue()
        self.symmetry="SYMMETRY "+self.symmetry_entry1.getvalue()+" "+self.symmetry_entry2.getvalue()
        ...
        self.component_representation="COMPONENT_REPRESENTATION "+self.component_representation_menu.getvalue()
        
        self.rotation_freq="ROTATION_FREQ "+self.rotation_freq_entry.getvalue()
        self.rotation_cov_freq="ROTATION_COV_FREQ "+self.rotation_cov_freq_entry.getvalue()
        self.translation_freq="TRANSLATION_FREQ "+self.translation_freq_entry.getvalue()
        ...
        self.translation_all_freq="TRANSLATION_ALL_FREQ "+self.translation_all_freq_entry.getvalue()
        self.rotation_all_freq="ROTATION_ALL_FREQ "+self.rotation_all_freq_entry.getvalue()
        self.exchangesample_freq="EXCHANGESAMPLE_FREQ "+self.exchangesample_freq_entry.getvalue()
        ...
        self.write_eachbetter="WRITE_EACHBETTER "+self.write_eachbetter_menu.getvalue()
        
        self.ann_temp="ANN_TEMP "+self.ann_temp_entry.getvalue()
        self.replicaexchange_freq="REPLICAEXCHANGE_FREQ "+self.replicaexchange_freq_entry.getvalue()
        self.replicatemperatures="REPLICATEMPERATURES "+self.replicatemperatures_entry.getvalue()
...
class P3F:
    ...
    def ig_choose_output_folder(self,parent,entry):
        outpath=tkFileDialog.askdirectory(parent=parent,initialdir="/",title="Choose output folder")
    ...
    def ig_choose_resfile(self,parent,entry):
        outpath=tkFileDialog.askopenfilename(parent=parent,initialdir="/",title="Choose file")
        entry.setvalue(outpath)
        entry.configure(entry_state="disabled")
        return outpath
        
    def generate_input_files(self,outpath,inpath,respath,mappath,cfg_v,str_v,res_v,seq_v,map_v,nowindow=0,rankmode=0,rankname=""):
        #print "IP", inpath
        #print "OP", outpath
        if outpath == "" or outpath == None:
            tkMessageBox.showinfo("Output directory?", "Please choose an output directory for your files.")
        else:
            check_outdir=1
            if nowindow==0:
				if rankmode == 0:
            ...
            if str_v == 1 and errcheck==0:
                ...
                print "Done."
                #except:
                 #   Display.simpledialog("Error","No structures opened. Use \"Open models\" card to open structures.")
                  #  errcheck=1
            ...
            if res_v == 1 and errcheck==0:
                if respath=="" or respath==None:
                    tkMessageBox.showinfo("Restraints file?", "Please choose a restraints file.")
                    errcheck=1
                else:
            ...
            if seq_v == 1 and errcheck==0:
                ...
                inseq.generate_pyry_insequences(outpath+"/sequences.fasta",instr.structures)
                print "Done."
            ...
            if errcheck==0:
                if nowindow==0:
                    tkMessageBox.showinfo("Success", "Input files generated successfully.")
    ...
    def check_dir(self,dire):
        if not os.path.exists(dire):
            ...
            def go_ahead_then(dire):
                shutil.rmtree(dire)
                os.makedirs(dire)
            wte=tkMessageBox.askyesno("Warning","All files in\n"+dire+"\nwill be deleted. Continue?")
            if wte==True:
                ...
                if wtd==True:
                    ...
                    tkMessageBox.showinfo("PyRy3D info", "Choose a different directory \n and try again.")
                    return 0
            else:
                tkMessageBox.showinfo("PyRy3D info", "Choose a different directory \n and try again.")
                return 0
